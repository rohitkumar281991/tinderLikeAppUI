...
import com.swipe.view.swipeappliketinder.tindercard.FlingCardListener;
import com.swipe.view.swipeappliketinder.tindercard.SwipeFlingAdapterView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        flingContainer.setFlingListener(new SwipeFlingAdapterView.onFlingListener() {
            ...
            public void onLeftCardExit(Object dataObject) {
                al.remove(0);
                myAppAdapter.notifyDataSetChanged();
                Toast.makeText(MainActivity.this,"Rejected "+dataObject.toString(),Toast.LENGTH_LONG).show();
